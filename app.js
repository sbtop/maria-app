...
// App State
// App State with Error Resilience
let supplements = [];
...
try {
    supplements = JSON.parse(localStorage.getItem('maria-supps')) || [];
    completedExercises = JSON.parse(localStorage.getItem('maria-completed')) || {};
...
window.onerror = function (msg, url, line) {
    ...
    errorDiv.style.cssText = "position:fixed; top:0; left:0; background:rgba(255,0,0,0.8); color:white; font-size:10px; z-index:9999; padding:5px;";
